        ...
        <View>
            <View style={{position:'relative', marginTop: 5}}>
                <View style={styles.viewHandler2}>
                    ...
                    <Text style={styles.textHandler}>Signup</Text>
                <View style={styles.viewHandler}>
                    <Image style={{width:100, height:100}} source={require('../assets/images/signup.png')}/>
                </View>
            </View>
        </View>
      </View>
        ...
        <View>
        {
                userLoading ? (
                    ...
                    <TouchableOpacity onPress={addLogin} style={styles.finalTouch}>
                        <Text style={styles.textHandler2}>Create Account</Text>
                    </TouchableOpacity>
                )
            }
